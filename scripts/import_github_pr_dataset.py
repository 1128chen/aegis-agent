...
from aegis.evaluation_harness import validate_case  # noqa: E402
from aegis.evaluation_v2 import validate_real_dataset  # noqa: E402
...
def fetch_diff(repository, pull_request, token=""):
    ...
    headers = {
        ...
        "User-Agent": "aegis-evaluation-importer",
