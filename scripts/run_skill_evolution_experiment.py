...
from aegis.evaluation_experiments import SkillEvolutionExperimentSuite  # noqa: E402
from aegis.evaluation_experiments import prepare_controlled_experiment_cases  # noqa: E402
from aegis.evaluation_harness import load_jsonl  # noqa: E402
from aegis.llm import JsonChatClient  # noqa: E402
from aegis.skill_evolution import (  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--base-url", default=os.getenv("AEGIS_LLM_BASE_URL", ""))
    parser.add_argument("--api-key", default=os.getenv("AEGIS_LLM_API_KEY", ""))
    parser.add_argument("--model", default=os.getenv("AEGIS_LLM_MODEL", ""))
    parser.add_argument("--provider", default=os.getenv("AEGIS_LLM_PROVIDER", "custom"))
