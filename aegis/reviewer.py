...
from .models import Finding, Severity, normalize_risk_class
...
class OpenAICompatibleReviewer(Reviewer):
    ...
    def _review(
        ...
        schema = (
            ...
            '"fix":"...","test":"...","confidence":0.0,"risk_class":"optional-vertical-taxonomy"}]}. '
            "Report only actionable defects introduced "
